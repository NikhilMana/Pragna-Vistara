/**
 * Generated Catalog: Class VIII - English
 */
export const ENGLISH_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'englishIntro',
          learningObjectives: [
            'Understand the basic concepts of English',
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of English in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think English is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'English provides the foundational rules governing real-world interactions.',
