/**
 * Generated Catalog: Class VIII - Hindi
 */
export const HINDI_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'hindiIntro',
          learningObjectives: [
            'Understand the basic concepts of Hindi',
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Hindi in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Hindi is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Hindi provides the foundational rules governing real-world interactions.',
