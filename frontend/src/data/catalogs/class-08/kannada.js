/**
 * Generated Catalog: Class VIII - Kannada
 */
export const KANNADA_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'kannadaIntro',
          learningObjectives: [
            'Understand the basic concepts of Kannada',
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Kannada in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Kannada is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Kannada provides the foundational rules governing real-world interactions.',
