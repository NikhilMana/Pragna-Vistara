/**
 * Generated Catalog: Class VIII - Mathematics
 */
export const MATHEMATICS_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'mathematicsIntro',
          learningObjectives: [
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Mathematics in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Mathematics is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Mathematics provides the foundational rules governing real-world interactions.',
