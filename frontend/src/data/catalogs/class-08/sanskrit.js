/**
 * Generated Catalog: Class VIII - Sanskrit
 */
export const SANSKRIT_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'sanskritIntro',
          learningObjectives: [
            'Understand the basic concepts of Sanskrit',
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Sanskrit in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Sanskrit is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Sanskrit provides the foundational rules governing real-world interactions.',
