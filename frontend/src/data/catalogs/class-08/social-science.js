/**
 * Generated Catalog: Class VIII - Social Science
 */
export const SOCIAL_SCIENCE_CLASS_08 = {
  classId: 'class-08',
      ...
      topics: [
        {
          ...
          animationType: 'social-scienceIntro',
          learningObjectives: [
            'Understand the basic concepts of Social Science',
          ...
          questions: [
            {
              id: 'ch1-t1-q1',
              text: 'Explain the fundamental importance of Social Science in everyday life.',
          ...
          misconceptions: [
            {
              id: 'ch1-t1-m1',
              probe: 'Do you think Social Science is only theoretical and has no real-world use?',
              options: ['Yes, it is mostly abstract', 'No, it applies directly to reality'],
              correctIndex: 1,
              correction: 'Social Science provides the foundational rules governing real-world interactions.',
