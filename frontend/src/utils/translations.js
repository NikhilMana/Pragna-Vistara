...
export const phraseTranslations = {
  hi: {
    ...
    'Reload to use the latest app version.': 'नवीनतम ऐप संस्करण उपयोग करने के लिए रीलोड करें.',
    Reload: 'रीलोड',
    'App is ready to work offline.': 'ऐप ऑफलाइन काम करने के लिए तैयार है.',
    'Install Pragna Vistara': 'प्रज्ञा विस्तार इंस्टॉल करें',
    'Add it as an app on this device.': 'इसे इस डिवाइस पर ऐप के रूप में जोड़ें.',
  ...
  kn: {
    ...
    'Update ready': 'ನವೀಕರಣ ಸಿದ್ಧವಾಗಿದೆ',
    'Reload to use the latest app version.': 'ಹೊಸ ಆವೃತ್ತಿಯನ್ನು ಬಳಸಲು ಪುಟವನ್ನು ಮರುಲೋಡ್ ಮಾಡಿ.',
    Reload: 'ಮರುಲೋಡ್',
    'App is ready to work offline.': 'ಆಪ್ ಆಫ್‌ಲೈನ್‌ನಲ್ಲಿ ಕೆಲಸ ಮಾಡಲು ಸಿದ್ಧವಾಗಿದೆ.',
    'Install Pragna Vistara': 'ಪ್ರಜ್ಞಾ ವಿಸ್ತಾರವನ್ನು ಇನ್‌ಸ್ಟಾಲ್ ಮಾಡಿ',
    'Add it as an app on this device.': 'ಈ ಸಾಧನದಲ್ಲಿ ಇದನ್ನು ಆಪ್ ಆಗಿ ಸೇರಿಸಿ.',
    Install: 'ಇನ್‌ಸ್ಟಾಲ್',
...
function translatePattern(language, phrase, dictionary) {
  ...
  const range = phrase.match(/^([A-Za-z0-9 .-]{1,24})\s+to\s+([A-Za-z0-9 .-]{1,24})$/)
  if (range) {
    return language === 'hi'
      ? `${range[1]} से ${range[2]}`
